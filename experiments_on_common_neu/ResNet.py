...
#first define the Residual block
...
train_iter,test_iter,train_data_size,test_data_size=alx.load_data()
alx.train_to_device(net,train_iter,test_iter,num_epochs,lr,"cuda")
